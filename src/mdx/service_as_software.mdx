...
I’ve spent most of this week thinking about the same thing. Not AI in general.
...
That’s exciting, but it’s also slightly uncomfortable.

Because it raises a different question.
...
But I don’t think that’s the most interesting part. The more interesting part is what happens to thinking.
...
Even if the capability is there, not every team will realise it.

It’s no longer just about tools, or even skill.
...
That requires a different kind of environment; one where it’s safe to experiment. Where not everything has to be production-ready on day one.

Where leadership understands that some of the value comes from exploring the edge, not just delivering the plan.

## This is where leadership shows up

Which brings it back to something more familiar.
...
That all still has a place.

But it starts to feel slightly out of step with what these systems make possible.
...
You’re not stepping away to learn something. You’re learning in the moment you need it.
...
Navigating tools like Planner/ADO.  
...
There’s also a question here about how organisations respond. If smaller teams can suddenly produce much more, what happens to the way we structure work?
...
Another thought I’ve been circling this week is how this might affect the way we structure delivery.
...
Which again shifts the question. If the tools become flexible enough, the differentiation isn’t the tool.
